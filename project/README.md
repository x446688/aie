...
- **Название проекта:** `Система прогнозирования спроса на товар/продукт`
- **Автор:** `Лидский Алексей Алексеевич`
- **Группа:** `ККСО-21-24`
- **Контакт:** `lidskiy_a_a@icloud.com`

- **Краткое описание (2-4 предложения):**  
  `Проект решает задачу оценки целесообразности продолжения продвижения товара/продукта на рынке. Используются открытые и синтетические датасеты, модели регрессии и ансмбли (для бейзлайна); LSTM и GRU`
