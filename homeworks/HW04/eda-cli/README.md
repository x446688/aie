...
### 5. `POST /quality-flags-from-csv` – вывод флагов качества по CSV-файлу
...
- вызывает функции из `eda_cli.core`:
  ...
  - `summarize_dataset`,
  - `value_table (missing_table)`,
  - `value_table (zeros_table)`,
  - `compute_quality_flags`;
- возвращает список флагов качества датасета.
...
```json
{
  "flags": {
    ...
    "too_many_missing": false,
    "duplicates_share": 0.02,
    "too_many_duplicates": false,
    "suspicious_id_duplicates": 0,
    "quality_score": 0.7
  }
}
```
